...
const ColumnStaffSalary = ({ isChecks, setIsChecks }) => {
  return [
    {
      title: 'Salary',
      name: 'a',
    ...
    },
    {
      ...
      formItem: {
        ...
        col: 6,
        onChange: (value, form) => {
          setIsChecks({ ...isChecks, isProductCommission: value });
          if (!value) form.setFieldsValue({ productCommission: '' });
        },
      },
    },
    {
      ...
      formItem: {
        mask: maskNumber,
        disabled: () => {
          return !isChecks.isProductCommission;
        },
        addonBefore: () => (
          <p className="text-center" style={{ width: 40 }}>
            %
        ...
        col: 6,
        onChange: (value, form) => {
          const isProductCommission = form.getFieldValue('isProductCommission');
          if (!isProductCommission) form.setFieldsValue({ productCommission: '' });
        },
      },
    },
    {
    ...
    },
    {
      ...
      formItem: {
        ...
        onChange: (value, form) => {
          ...
          if (value) {
            setIsChecks({ ...isChecks, isTipPercent: value, isTipFixed: valueStemp });
            form.setFieldsValue({
              ...data,
              isTipPercent: value,
    ...
    },
    {
      ...
      formItem: {
        mask: maskNumber,
        disabled: () => !isChecks?.isTipPercent,
        addonBefore: () => (
          <p className="text-center" style={{ width: 40 }}>
            %
          </p>
        ...
        col: 6,
        onChange: (value, form) => {
          const isTipPercent = form.getFieldValue('isTipPercent');
          if (!isTipPercent) form.setFieldsValue({ tipPercent: '' });
        },
      },
    },
    {
      ...
      formItem: {
        ...
        onChange: (value, form) => {
          ...
          if (value) {
            setIsChecks({ ...isChecks, isTipPercent: valueStemp, isTipFixed: value });
            form.setFieldsValue({
              ...data,
              isTipFixed: value,
...
export default ColumnStaffSalary;
